...
const interviewResultCollection =
  process.env.ASTRA_DB_INTERVIEWHISTORY_COLLECTIONS;
const interviewSessionCollection =
  process.env.ASTRA_DB_INTERVIEWSESSION_COLLECTIONS;
...
export const vectorSearch = async (input, feature) => {
  ...
  try {
    const result = await AstraDBRequest(
      vectorSearchConfig,
      vectorSearchCollection
    );
    const output = result.data.data.documents
...
export const loadChatHistory = async (sessionID) => {
  ...
  try {
    const loadedChat = await AstraDBRequest(
...
export const updateChatHistory = async (sessionID, chat) => {
  ...
  try {
    const update = await AstraDBRequest(
...
export const loadUserSessions = async (userID, archive) => {
  ...
  try {
    const userSessions = await AstraDBRequest(
      loadUserSessionsRequest,
      userSessionsCollection
    );
    console.log("success load userSessions");
    console.log(userSessions.data.data.documents)
...
export const addInterviewHistory = async (
  interviewResult,
  grade,
  userID,
  sessionID,
  ...
  try {
    await AstraDBRequest(
      addInterviewSessionRequest,
      interviewSessionCollection
    );
...
export const loadAllInterviews = async (userID) => {
  ...
  try {
    const userSessions = await AstraDBRequest(
      loadUserInterviewSessionsRequest,
      interviewSessionCollection
    );
...
export const loadInterviewResult = async (sessionID) => {
  ...
  try {
    const loadedChat = await AstraDBRequest(
      loadInterviewHistoryRequest,
      interviewResultCollection
    );
