...
const userSessionsCollection = "user_session";
const interviewResultCollection = "interview_history";
const interviewSessionCollection = "user_interview";
...
export const addUserSession = async (sessionID, userID) => {
    const addUserSessionRequest = {
        "insertOne": {
            "document": {
                "_id" : sessionID,
                "userID": userID,
    ...
    try {
        await AstraDBRequest(addUserSessionRequest, userSessionsCollection);
