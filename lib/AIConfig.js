  ...
  try {
    console.log(process.env.API_KEY)
        const response = await axios.post(
          `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent?key=${process.env.API_KEY}`,
          {
...
const getToken = async () => {
  const access_token = await axios.post('https://accounts.google.com/o/oauth2/token', {
