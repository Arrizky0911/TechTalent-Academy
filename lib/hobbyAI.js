...
export const searchHobby = async (searchHobby) => {
    const information = await vectorSearch(`${searchHobby} related job roadmap`)
    const prompt = `
    ...
    The content of the respond must be in Indonesian Language or English depending on the what language is the input text.
