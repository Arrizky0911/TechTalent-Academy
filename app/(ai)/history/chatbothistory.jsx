        ...
        {["Edit", isArchived, "Delete"].map((option, index) => (
          ...
          >
            <View className="flex-row items-center">
              ...
              {option === isArchived && <ArchiveBoxIcon size={18} color="white" />}
...
const ChatHistory = () => {
  ...
  const {data: userHistorySessions, isLoading , refetch} = useFetchData(() => loadUserSessions(user.$id))
        ...
        <TouchableOpacity 
          ...
          <View className="flex-row justify-between items-center border border-[#3F454D] rounded-2xl p-4">
            ...
            <TouchableOpacity onPress={() => {
              ...
              setIsSessionArchived(item.status === "archived" ? "Unarchive" : "Archive");
              }}>
