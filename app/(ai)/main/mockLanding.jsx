      ...
      >
        <View className="bg-[#30353C] w-full h-full absolute pt-14">
          ...
          <Reanimated.View
            ...
            className="flex-1 w-full h-full bg-[#111315] relative rounded-t-3xl"
          >
            ...
            <Text className="text-gray-400 font-geistRegular text-center text-xs m-2">
              Select your dream job role and let's kickstart a tailored
              interview simulation just for you!
            </Text>
            <ScrollView
              ref={scrollViewRef}
              style={{ flex: 1 }}
            ...
            >
              <Reanimated.View
                ...
                className="flex-wrap flex-row mt-2 w-full px-5 justify-between"
              >
                {jobs.map((job, index) => (
                  <TouchableOpacity
                    key={index}
            ...
            <Reanimated.View
              ...
              className="flex-1 justify-end items-center pb-5 mx-5"
            >
              <TouchableOpacity
                ...
                disabled={
                  selectedJob &&
                  (selectedJob !== "Another Job" || !(anotherJob == ""))
                    ? false
                    : true
                }
              >
          ...
          >
            ...
            >
              <Reanimated.View
                ...
                className="bg-[#111315] rounded-lg p-6 w-11/12 max-h-3/4"
              >
                ...
                >
                  <View className="ml-5">
                    <Text className="text-gray-200 font-geistRegular text-sm mb-3">
                      <Text className="font-geistSemiBold">1.</Text> Prepare
                      yourself properly before starting.
                    </Text>
                    <Text className="text-gray-200 font-geistRegular text-sm mb-3">
                      <Text className="font-geistSemiBold">2.</Text> Speak
                      clearly and keep your voice loud.
                    </Text>
                    <Text className="text-gray-200 font-geistRegular text-sm mb-3">
                      <Text className="font-geistSemiBold">3.</Text> Button
                      Functions:
                    </Text>
                    <View className="ml-5">
                      <Text className="text-gray-200 font-geistRegular text-sm mb-2">
                        - To start speaking, click the mic button in the center.
                        Click it again to stop the recording.
                      </Text>
                      <Text className="text-gray-200 font-geistRegular text-sm mb-2">
                        - Click the "Next" button on the right to move to the
                        next question. At the last question, click the button to
                        end the mock interview.
                      </Text>
                      <Text className="text-gray-200 font-geistRegular text-sm mb-2">
                        - Click the "X" button on the left to repeat the current
                        question. For example, if you're on question 4 and click
                        the "X" button, it will repeat question 4, not from the
                        beginning.
                      </Text>
                    </View>
                  </View>
                ...
                <TouchableOpacity
                  onPress={() => {
                    ...
                    router.push(
                      `mockInterview/${
                        selectedJob === "Another Job" ? anotherJob : selectedJob
                      }`
                    );
                  }}
